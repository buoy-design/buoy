...
const mockBuildAutoConfig = autoDetect.buildAutoConfig as ReturnType<typeof vi.fn>;
const mockScanOrchestrator = orchestrator.ScanOrchestrator as ReturnType<typeof vi.fn>;
const mockSemanticDiffEngine = analysis.SemanticDiffEngine as ReturnType<typeof vi.fn>;
  ...
  describe('export subcommand', () => {
    describe('options', () => {
      it('has --output option', () => {
        ...
        const options = exportCmd?.options.map((o) => o.long?.replace('--', ''));
    ...
    describe('execution', () => {
      it('scans components and tokens', async () => {
        ...
        await program.parseAsync(['node', 'test', 'skill', 'export', '--dry-run']);
      ...
      it('uses global path when --global specified', async () => {
        ...
        const program = createTestProgram();
        await program.parseAsync(['node', 'test', 'skill', 'export', '--global']);
    ...
    describe('content quality', () => {
      ...
      it('includes component names in inventory', async () => {
        setupMocks([createMockComponent('Button'), createMockComponent('Card')]);
